...
exports.updateNote = exports.trashNote = exports.getNote = exports.getAllNote = exports.deleteNote = exports.archieveNote = exports.addNewNote = void 0;
...
var getAllNote = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return NoteService.getAllNote(req.body);
  ...
  return function getAllNote(_x4, _x5, _x6) {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            _context3.next = 3;
            return NoteService.getNote(req.params.noteid);
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.prev = 0;
            _context4.next = 3;
            return NoteService.updateNote(req.params.noteid, req.body);
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            _context5.prev = 0;
            _context5.next = 3;
            return NoteService.deleteNote(req.params.noteid);
...
var archieveNote = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            _context6.prev = 0;
            _context6.next = 3;
            return NoteService.archieveNote(req.params.noteid);
  ...
  return function archieveNote(_x16, _x17, _x18) {
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            _context7.prev = 0;
            _context7.next = 3;
            return NoteService.trashNote(req.params.noteid);
